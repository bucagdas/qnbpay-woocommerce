...
function qnbpay_admin_settings_assets($hook)
{
    ...
    wp_enqueue_script('qnbpay-admin-settings', plugins_url('assets/js/admin-settings.js', __FILE__), array(), '1.2.2', true);
    ...
    wp_localize_script('qnbpay-admin-settings', 'qnbpayAdminData', array(
        ...
        'previews'        => $previews,
        'defaultTitle'    => __('Banka/Kredi Kartı ile Öde', 'QNBPay'),
    ));
}
